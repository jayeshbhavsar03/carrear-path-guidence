...
<head>
    ...
    <title>WN Question Papers</title>
...
<body>
    ...
    <section class="add-products">
        ...
        <h4 style="text-align: center;font-size: 1.5rem;text-transform: capitalize;padding: 1rem;">WN Added Question Papers</h4>

        <?php  
        $i = 1;
        $select_products = mysqli_query($conn, "SELECT * FROM `que_paper` WHERE `sub`='2'") or die('query failed');
        ...
        <div class="sec" style="text-align: initial;padding: 2rem 3rem;">
            ...
            <div class="host-name "><span>Subject Name: </span> <span class="sp">WN</span></div>
            <h5>Q.1&#41;</h5>
            ...
            <a href="sub2.php?delete=<?php echo $fetch_products['id']; ?>" onclick="return confirm('delete this paper?');" class="delete-btn">Delete Paper</a>
        </div>
        <?php
         }
        }else{      
